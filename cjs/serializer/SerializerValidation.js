...
var _my = {
    ...
    require_object_type(reserved_spaces = 1, type, value, field_name = "") {
        ...
        var object_type = ChainTypes_1.ChainTypes.object_type[type];
        if (!object_type) {
    ...
    get_protocol_type_name(value, field_name) {
        ...
        return Object.keys(ChainTypes_1.ChainTypes.object_type)[type_id];
    },
    ...
    no_overflow64(value, field_name = "") {
        ...
        if (typeof value === "string") {
            ...
            var long_string = long_1.default.fromString(value).toString();
