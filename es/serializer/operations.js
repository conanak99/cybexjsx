...
// id_type,
// varint32,
uint8 = types.uint8, uint16 = types.uint16, uint32 = types.uint32, int64 = types.int64, uint64 = types.uint64, string = types.string, bytes = types.bytes, bool = types.bool, array = types.array, fixed_array = types.fixed_array, protocol_id_type = types.protocol_id_type, object_id_type = types.object_id_type, vote_id = types.vote_id, 
// future_extensions,
static_variant = types.static_variant, map = types.map, set = types.set, public_key = types.public_key, address = types.address, time_point_sec = types.time_point_sec, optional = types.optional;
...
export var initiate_crowdfund_operation_fee_parameters = new Serializer("initiate_crowdfund_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32
});
export var participate_crowdfund_operation_fee_parameters = new Serializer("participate_crowdfund_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32
});
export var withdraw_crowdfund_operation_fee_parameters = new Serializer("withdraw_crowdfund_operation_fee_parameters", {
    fee: uint64,
    price_per_kbyte: uint32
});
...
export var participate_crowdfund = new Serializer("participate_crowdfund", {
    fee: asset,
...
export var withdraw_crowdfund = new Serializer("withdraw_crowdfund", {
    fee: asset,
    buyer: protocol_id_type("account"),
    crowdfund_contract: protocol_id_type("crowdfund_contract")
});
export var initiate_crowdfund = new Serializer("initiate_crowdfund", {
    fee: asset,
...
export var fund_query = new Serializer("fund_query", {
    accountName: string,
...
export var set_refer = new Serializer("set_refer", {
    account: string,
    action: string,
    referrer: string,
    expiration: int64
});
export var query_address = new Serializer("query_address", {
    loginName: string,
    expiration: int64
});
export var set_address = new Serializer("set_address", {
    loginName: string,
    receiverName: string,
    email: string,
    qqNo: string,
