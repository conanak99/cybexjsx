...
var _internal = {
    ...
    to_long64: function (number_or_string, precision, error_info) {
        if (error_info === void 0) { error_info = ""; }
    ...
    decimal_precision_string: function (number, precision, error_info) {
        if (error_info === void 0) { error_info = ""; }
...
_my = {
    ...
    to_bigint64: function (number_or_string, precision, error_info) {
        if (error_info === void 0) { error_info = ""; }
    ...
    to_string64: function (number_or_string, precision, error_info) {
        if (error_info === void 0) { error_info = ""; }
