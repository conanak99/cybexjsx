...
const { Hex: encHex, Base64: encBase64 } = enc;
...
class Aes {
  ...
  static decrypt_with_checksum(
    ...
    var new_checksum: any = sha256(plaintext);
  ...
  _decrypt_word_array(cipher) {
    ...
    return AES.decrypt({ ciphertext: cipher, salt: null } as any, this.key, {
      iv: this.iv
    });
  }
