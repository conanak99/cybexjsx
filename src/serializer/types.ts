...
const bytes = function(size?: number) {
  return {
    fromByteBuffer(b) {
      if (size === undefined) {
        var b_copy;
...
const protocol_id_type = function(name: string) {
...
const optional = function(st_operation?: any) {
...
const static_variant = function(_st_operations?: any) {
  return {
    nosort: true,
